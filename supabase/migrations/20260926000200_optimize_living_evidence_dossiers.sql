-- Replace the first dossier snapshot implementation with one set-based pass
-- over each topic's research and trial relations. This keeps the richer public
-- dossier from multiplying database reads as global traffic grows.
